...
export function ContactWithPlanForm() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-2 lg:h-full lg:min-h-0 lg:items-stretch lg:overflow-hidden">
      {/* Left side - Title + Form (sticky so long plan lists don't push it away) */}
      <div className="flex min-h-0 flex-col lg:sticky lg:top-0 lg:self-start lg:max-h-full lg:overflow-y-auto">
        <div className="mb-4">
      ...
      {/* Right side - Search + Plan items (plan list uses remaining height) */}
      <div className="text-fg-soft flex min-h-0 flex-col lg:h-full lg:overflow-hidden lg:pr-2">
        ...
        {/* Plan items — scroll inside remaining column height */}
