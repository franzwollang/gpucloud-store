...
export function ContactWithPlanForm() {
  ...
  return (
    <div className="grid gap-5 lg:grid-cols-2 lg:h-full lg:min-h-0 lg:items-stretch lg:overflow-hidden">
      {/* Left side - Title + Form (sticky so it stays usable beside a long plan list) */}
      <div className="flex min-h-0 flex-col lg:sticky lg:top-0 lg:self-start">
        <div className="mb-4">
      ...
      {/* Right side - Search + Plan items (plan list fills leftover height) */}
      <div className="text-fg-soft flex min-h-0 flex-col lg:h-full lg:overflow-hidden lg:pr-2">
        ...
        {/* Plan items - fill leftover column height; scroll inside the list */}
        <div className="border-border/40 bg-bg-surface/50 flex min-h-[12rem] flex-1 flex-col rounded-lg border p-3 lg:min-h-0">
